  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-3xl w-full">
        <div className={`${cardBase} border rounded-2xl p-6 flex flex-col`}>
          ...
          <button
            ...
            className="w-full py-2 rounded-lg border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition text-sm font-medium"
          >
            Current plan
          </button>
        </div>

        <div className={`${cardBase} border-2 border-blue-500 rounded-2xl p-6 flex flex-col relative`}>
          <span className="absolute top-4 right-4 text-xs font-medium px-2 py-0.5 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400">
            Most popular
          </span>
          ...
          <button
            ...
            className="w-full py-2.5 rounded-lg font-semibold bg-blue-600 text-white hover:bg-blue-700 transition text-sm"
          >
            Get Premium
          </button>
        </div>
